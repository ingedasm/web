...
namespace GeneXus.Programs.general.security {
   public class notauthorized : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(GxObject))}, new string[] {"GxObject"}) +"\">") ;
      ...
      {
         return formatLink("general.security.notauthorized.aspx", new object[] {UrlEncode(StringUtil.RTrim(GxObject))}, new string[] {"GxObject"})  ;
      }
      ...
      protected void WB1L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_3_1L2( true) ;
         }
         else
         {
            wb_table1_3_1L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_3_1L2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_12_1L2( true) ;
         }
         else
         {
            wb_table2_12_1L2( false) ;
         }
         return  ;
      }

      protected void wb_table2_12_1L2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_15_1L2( true) ;
         }
         else
         {
            wb_table3_15_1L2( false) ;
         }
         return  ;
      }

      protected void wb_table3_15_1L2e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void wb_table3_15_1L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_15_1L2e( true) ;
         }
         else
         {
            wb_table3_15_1L2e( false) ;
         }
      }

      protected void wb_table2_12_1L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_12_1L2e( true) ;
         }
         else
         {
            wb_table2_12_1L2e( false) ;
         }
      }

      protected void wb_table1_3_1L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Not Authorized", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_General\\Security\\NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td colspan=\"2\" >") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_3_1L2e( true) ;
         }
         else
         {
            wb_table1_3_1L2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249209135550", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("general/security/notauthorized.js", "?20249209135551", false, true);
