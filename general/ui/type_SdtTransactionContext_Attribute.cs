/*
			...
			Description: Attributes
				 Author: Nemo 🐠 for C# version 18.0.1.167910
...
namespace GeneXus.Programs.general.ui
{
	...
	[XmlType(TypeName="TransactionContext.Attribute" , Namespace="KbIndicadores" )]
	[Serializable]
	...
	[DataContract(Name=@"TransactionContext.Attribute", Namespace="KbIndicadores")]
