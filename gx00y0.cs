...
namespace GeneXus.Programs {
   public class gx00y0 : GXDataArea
   {
      public gx00y0( )
      {
      ...
      public void execute( out string aP0_pTIPOSCPOCod )
      {
         this.AV6pTIPOSCPOCod = "" ;
         executePrivate();
         aP0_pTIPOSCPOCod=this.AV6pTIPOSCPOCod;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pTIPOSCPOCod");
            ...
            {
               AV6pTIPOSCPOCod = gxfirstwebparm;
               AssignAttri("", false, "AV6pTIPOSCPOCod", AV6pTIPOSCPOCod);
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00y0.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6pTIPOSCPOCod))}, new string[] {"pTIPOSCPOCod"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPTIPOSCPOCOD", AV6pTIPOSCPOCod);
      ...
      {
         return formatLink("gx00y0.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6pTIPOSCPOCod))}, new string[] {"pTIPOSCPOCod"})  ;
      }
      ...
      {
         return "Selection List TIPOSCPO" ;
      }
      ...
      protected void WB120( )
      {
         ...
         if ( wbEnd == 9 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(9), 1, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00Y0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START122( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List TIPOSCPO", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF122( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A64TIPOSCPOCod = H00122_A64TIPOSCPOCod[0];
               /* Execute user event: Load */
               E12122 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_TIPOSCPOCOD"+"_"+sGXsfl_9_idx, GetSecureSignedToken( sGXsfl_9_idx, StringUtil.RTrim( context.localUtil.Format( A64TIPOSCPOCod, "")), context));
      }
      ...
      protected void E11122( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "TIPOSCPO", "", "", "", "", "", "", "", "");
      ...
      protected void E13122( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV6pTIPOSCPOCod = A64TIPOSCPOCod;
         AssignAttri("", false, "AV6pTIPOSCPOCod", AV6pTIPOSCPOCod);
         context.setWebReturnParms(new Object[] {(string)AV6pTIPOSCPOCod});
         context.setWebReturnParmsMetadata(new Object[] {"AV6pTIPOSCPOCod"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6pTIPOSCPOCod = (string)getParm(obj,0);
         AssignAttri("", false, "AV6pTIPOSCPOCod", AV6pTIPOSCPOCod);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20247231024795", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00y0.js", "?20247231024795", false, true);
      ...
      protected void SubsflControlProps_92( )
      {
         ...
         edtTIPOSCPOCod_Internalname = "TIPOSCPOCOD_"+sGXsfl_9_idx;
      }

      protected void SubsflControlProps_fel_92( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_9_fel_idx;
         edtTIPOSCPOCod_Internalname = "TIPOSCPOCOD_"+sGXsfl_9_fel_idx;
      }
      ...
      protected void sendrow_92( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_9_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( A64TIPOSCPOCod)+"'"+"]);";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List TIPOSCPO";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E13122',iparms:[{av:'A64TIPOSCPOCod',fld:'TIPOSCPOCOD',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV6pTIPOSCPOCod',fld:'vPTIPOSCPOCOD',pic:''}]}");
         ...
         setEventMetadata("NULL","{handler:'Valid_Tiposcpocod',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         A64TIPOSCPOCod = "";
         scmdbuf = "";
         H00122_A64TIPOSCPOCod = new string[] {""} ;
      ...
      private string AV6pTIPOSCPOCod ;
      ...
      private string[] H00122_A64TIPOSCPOCod ;
      private long[] H00123_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private string aP0_pTIPOSCPOCod ;
   ...
   public class gx00y0__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00122", "SELECT [TIPOSCPOCod] FROM [TIPOSCPO] ORDER BY [TIPOSCPOCod]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00122,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00123", "SELECT COUNT(*) FROM [TIPOSCPO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00123,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
