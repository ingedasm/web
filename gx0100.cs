...
namespace GeneXus.Programs {
   public class gx0100 : GXDataArea
   {
      public gx0100( )
      {
      ...
      public void execute( out string aP0_pMOTIVOTONRFFcod )
      {
         this.AV6pMOTIVOTONRFFcod = "" ;
         executePrivate();
         aP0_pMOTIVOTONRFFcod=this.AV6pMOTIVOTONRFFcod;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pMOTIVOTONRFFcod");
            ...
            {
               AV6pMOTIVOTONRFFcod = gxfirstwebparm;
               AssignAttri("", false, "AV6pMOTIVOTONRFFcod", AV6pMOTIVOTONRFFcod);
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0100.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6pMOTIVOTONRFFcod))}, new string[] {"pMOTIVOTONRFFcod"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPMOTIVOTONRFFCOD", AV6pMOTIVOTONRFFcod);
      ...
      {
         return formatLink("gx0100.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6pMOTIVOTONRFFcod))}, new string[] {"pMOTIVOTONRFFcod"})  ;
      }
      ...
      {
         return "Selection List MOTIVOTONRFF" ;
      }
      ...
      protected void WB130( )
      {
         ...
         if ( wbEnd == 9 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(9), 1, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0100.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START132( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List MOTIVOTONRFF", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF132( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A65MOTIVOTONRFFcod = H00132_A65MOTIVOTONRFFcod[0];
               /* Execute user event: Load */
               E12132 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_MOTIVOTONRFFCOD"+"_"+sGXsfl_9_idx, GetSecureSignedToken( sGXsfl_9_idx, StringUtil.RTrim( context.localUtil.Format( A65MOTIVOTONRFFcod, "")), context));
      }
      ...
      protected void E11132( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "MOTIVOTONRFF", "", "", "", "", "", "", "", "");
      ...
      protected void E13132( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV6pMOTIVOTONRFFcod = A65MOTIVOTONRFFcod;
         AssignAttri("", false, "AV6pMOTIVOTONRFFcod", AV6pMOTIVOTONRFFcod);
         context.setWebReturnParms(new Object[] {(string)AV6pMOTIVOTONRFFcod});
         context.setWebReturnParmsMetadata(new Object[] {"AV6pMOTIVOTONRFFcod"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6pMOTIVOTONRFFcod = (string)getParm(obj,0);
         AssignAttri("", false, "AV6pMOTIVOTONRFFcod", AV6pMOTIVOTONRFFcod);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20247231025258", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0100.js", "?20247231025258", false, true);
      ...
      protected void SubsflControlProps_92( )
      {
         ...
         edtMOTIVOTONRFFcod_Internalname = "MOTIVOTONRFFCOD_"+sGXsfl_9_idx;
      }

      protected void SubsflControlProps_fel_92( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_9_fel_idx;
         edtMOTIVOTONRFFcod_Internalname = "MOTIVOTONRFFCOD_"+sGXsfl_9_fel_idx;
      }
      ...
      protected void sendrow_92( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_9_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( A65MOTIVOTONRFFcod)+"'"+"]);";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List MOTIVOTONRFF";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E13132',iparms:[{av:'A65MOTIVOTONRFFcod',fld:'MOTIVOTONRFFCOD',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV6pMOTIVOTONRFFcod',fld:'vPMOTIVOTONRFFCOD',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         A65MOTIVOTONRFFcod = "";
         scmdbuf = "";
         H00132_A65MOTIVOTONRFFcod = new string[] {""} ;
      ...
      private string AV6pMOTIVOTONRFFcod ;
      ...
      private string[] H00132_A65MOTIVOTONRFFcod ;
      private long[] H00133_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private string aP0_pMOTIVOTONRFFcod ;
   ...
   public class gx0100__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00132", "SELECT [MOTIVOTONRFFcod] FROM [MOTIVOTONRFF] ORDER BY [MOTIVOTONRFFcod]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00132,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00133", "SELECT COUNT(*) FROM [MOTIVOTONRFF] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00133,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
