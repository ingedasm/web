...
namespace GeneXus.Programs {
   public class gx0120 : GXDataArea
   {
      public gx0120( )
      {
      ...
      public void execute( out string aP0_pMOTIVOSCOSRFFCodigo )
      {
         this.AV6pMOTIVOSCOSRFFCodigo = "" ;
         executePrivate();
         aP0_pMOTIVOSCOSRFFCodigo=this.AV6pMOTIVOSCOSRFFCodigo;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pMOTIVOSCOSRFFCodigo");
            ...
            {
               AV6pMOTIVOSCOSRFFCodigo = gxfirstwebparm;
               AssignAttri("", false, "AV6pMOTIVOSCOSRFFCodigo", AV6pMOTIVOSCOSRFFCodigo);
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0120.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6pMOTIVOSCOSRFFCodigo))}, new string[] {"pMOTIVOSCOSRFFCodigo"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPMOTIVOSCOSRFFCODIGO", AV6pMOTIVOSCOSRFFCodigo);
      ...
      {
         return formatLink("gx0120.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6pMOTIVOSCOSRFFCodigo))}, new string[] {"pMOTIVOSCOSRFFCodigo"})  ;
      }
      ...
      {
         return "Selection List MOTIVOSCOSRFF" ;
      }
      ...
      protected void WB160( )
      {
         ...
         if ( wbEnd == 9 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(9), 1, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0120.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START162( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List MOTIVOSCOSRFF", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF162( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A66MOTIVOSCOSRFFCodigo = H00162_A66MOTIVOSCOSRFFCodigo[0];
               /* Execute user event: Load */
               E12162 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_MOTIVOSCOSRFFCODIGO"+"_"+sGXsfl_9_idx, GetSecureSignedToken( sGXsfl_9_idx, StringUtil.RTrim( context.localUtil.Format( A66MOTIVOSCOSRFFCodigo, "")), context));
      }
      ...
      protected void E11162( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "MOTIVOSCOSRFF", "", "", "", "", "", "", "", "");
      ...
      protected void E13162( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV6pMOTIVOSCOSRFFCodigo = A66MOTIVOSCOSRFFCodigo;
         AssignAttri("", false, "AV6pMOTIVOSCOSRFFCodigo", AV6pMOTIVOSCOSRFFCodigo);
         context.setWebReturnParms(new Object[] {(string)AV6pMOTIVOSCOSRFFCodigo});
         context.setWebReturnParmsMetadata(new Object[] {"AV6pMOTIVOSCOSRFFCodigo"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6pMOTIVOSCOSRFFCodigo = (string)getParm(obj,0);
         AssignAttri("", false, "AV6pMOTIVOSCOSRFFCodigo", AV6pMOTIVOSCOSRFFCodigo);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20247231025616", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0120.js", "?20247231025616", false, true);
      ...
      protected void SubsflControlProps_92( )
      {
         ...
         edtMOTIVOSCOSRFFCodigo_Internalname = "MOTIVOSCOSRFFCODIGO_"+sGXsfl_9_idx;
      }

      protected void SubsflControlProps_fel_92( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_9_fel_idx;
         edtMOTIVOSCOSRFFCodigo_Internalname = "MOTIVOSCOSRFFCODIGO_"+sGXsfl_9_fel_idx;
      }
      ...
      protected void sendrow_92( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_9_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( A66MOTIVOSCOSRFFCodigo)+"'"+"]);";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List MOTIVOSCOSRFF";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E13162',iparms:[{av:'A66MOTIVOSCOSRFFCodigo',fld:'MOTIVOSCOSRFFCODIGO',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV6pMOTIVOSCOSRFFCodigo',fld:'vPMOTIVOSCOSRFFCODIGO',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00162_A66MOTIVOSCOSRFFCodigo = new string[] {""} ;
      ...
      private string AV6pMOTIVOSCOSRFFCodigo ;
      ...
      private string[] H00162_A66MOTIVOSCOSRFFCodigo ;
      private long[] H00163_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private string aP0_pMOTIVOSCOSRFFCodigo ;
   ...
   public class gx0120__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00162", "SELECT [MOTIVOSCOSRFFCodigo] FROM [MOTIVOSCOSRFF] ORDER BY [MOTIVOSCOSRFFCodigo]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00162,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00163", "SELECT COUNT(*) FROM [MOTIVOSCOSRFF] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00163,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
